...
var fadeSlideShow_descpanel={
	controls: [["<?php echo esc_url(plugin_dir_url( __FILE__ ) . 'admin/images/x.png'); ?>", 7, 7], ["<?php echo esc_url(plugin_dir_url( __FILE__ ) . 'admin/images/restore.png'); ?>", 10, 11], ["<?php echo esc_url(plugin_dir_url( __FILE__ ) . 'admin/images/loading.gif'); ?>", 54, 55]], //full URL and dimensions of close, restore, and loading images
